    ...
    try {
      ...
      if (error.response) {
        switch (error.response.status) {
          case 400:
            setMessage(
              "❌ User name or email already exists.Change User name Or Try logging in."
            );
            break;
          case 409:
          ...
          case 410:
            setMessage(
              "❌ Your password must be at least 8 characters long and include 1 uppercase,1 lowercase,1 number, and 1 special character."
            );
            break;
          default:
