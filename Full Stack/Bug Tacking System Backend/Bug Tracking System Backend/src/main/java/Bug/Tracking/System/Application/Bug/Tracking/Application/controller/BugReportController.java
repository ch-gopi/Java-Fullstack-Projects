   ...
   // @PreAuthorize("hasAnyRole('ADMIN','USER')")
    ...
    public ResponseEntity<Resource> viewCSV(@RequestParam Map<String, String> filters) {
        ...
        return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "inline; filename=\"bugs_report.csv\"") // ✅ Opens in browser
                .body(resource);
    }
   ...
   // @PreAuthorize("hasAnyRole('ADMIN','USER')")
    ...
    public ResponseEntity<Resource> viewPDF(@RequestParam Map<String, String> filters) {
        ...
        return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "inline; filename=\"bugs_report.pdf\"") // ✅ Opens in browser
                .body(resource);
    }
}
